                    ...
                    <div class="lg:col-span-5 relative">
                        <div class="relative w-full max-w-[460px] mx-auto">
                            <div
                                ...
                                <img src="{{ asset('images/cta-student.png') }}" alt="DigiCoders Blog Tech Workspace"
                                    class="w-full h-[260px] sm:h-[300px] object-cover rounded-[6px]">
                            </div>

                            <div
                                class="absolute -bottom-4 -left-4 bg-white/95 backdrop-blur-md border border-slate-200/90 rounded-[6px] p-3 shadow-lg flex items-center gap-3 z-20">
                                <div
                                    class="w-9 h-9 rounded-full bg-emerald-50 text-[#00A651] flex items-center justify-center shrink-0">
                                    <i data-lucide="book-open" class="w-5 h-5"></i>
                                </div>
                                <div>
                                    <p class="text-sm font-extrabold text-[#111111] font-heading">{{ $blogs->total() }}+
                                    </p>
                                    <p class="text-[10px] font-bold text-[#555555]">Published Guides</p>
                                </div>
                            </div>
                        </div>
                    </div>
