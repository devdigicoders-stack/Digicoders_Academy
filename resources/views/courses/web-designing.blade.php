...
<head>
    ...
    <!-- SEO Title & Meta -->
    <title>Web Designing Course (6 Months) - DigiCoders Academy</title>
    <meta name="description"
        content="Learn Web Designing at DigiCoders Academy. Master UI Design Basics, HTML5, CSS3, Flexbox, Grid, Bootstrap 5, JavaScript & Live Web Deployment.">
    <meta name="keywords"
        content="Web Designing course Lucknow, HTML CSS training, Frontend developer course Lucknow">
    ...
    <main class="w-full overflow-hidden">
        ...
        <section id="course-hero" class="relative w-full bg-white border-b border-slate-200/60 overflow-hidden py-14 lg:py-24 min-h-[420px] flex items-center">
            ...
            <div class="absolute inset-0 z-0">
                <img src="https://images.unsplash.com/photo-1507238691740-187a5b1d37b8?auto=format&fit=crop&w=1600&q=80"
                    alt="DigiCoders Web Lab" class="w-full h-full object-cover object-right opacity-90">
            ...
            <div class="relative z-10 w-full max-w-[1360px] mx-auto px-4 sm:px-6 lg:px-8">
                <div class="max-w-2xl space-y-5">
                    ...
                    <nav class="flex items-center gap-2 text-xs font-semibold text-[#666666]">
                        ...
                        <i data-lucide="chevron-right" class="w-3.5 h-3.5 text-slate-400"></i>
                        <span class="text-[#666666] font-bold">Web Designing</span>
                    </nav>
                    ...
                    <h1 class="text-3xl sm:text-4xl lg:text-5xl font-extrabold font-heading text-[#111111] tracking-tight leading-[1.15]">
                        Web Designing & <br>
                        <span class="text-[#00A651]">UI/UX Development</span>
                    </h1>

                    <div class="space-y-2 max-w-xl">
                        <h2 class="text-base sm:text-lg font-bold text-[#111111]">Design & Deploy Modern Responsive Websites</h2>
                        <p class="text-xs sm:text-sm text-[#555555] leading-relaxed font-normal">
                            Master UI design, HTML5, CSS3, Flexbox, Grid, Bootstrap 5, JavaScript programming, and GitHub/Netlify web deployment.
                        </p>
                    </div>
        ...
        <!-- 2️⃣ ABOUT WEB DESIGNING SECTION (100% Match with Reference Screenshot) -->
        <section id="about-course" class="py-14 sm:py-20 bg-white relative">
            <div class="w-full max-w-[1360px] mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="text-center max-w-xl mx-auto mb-10 sm:mb-14">
                    <h2 class="text-2xl sm:text-3xl lg:text-4xl font-extrabold font-heading text-[#111111]">About Web Designing</h2>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
                    ...
                    <div class="lg:col-span-5 space-y-4">
                        <p class="text-sm sm:text-base text-[#555555] leading-relaxed font-normal">
                            Web Designing is a 6-Month hands-on course covering UI layout design, color theory, HTML5, CSS3, Flexbox/Grid, Bootstrap 5 framework, JavaScript DOM scripting, and real live website deployment on Netlify & Vercel.
                        </p>
                    </div>
                ...
                <div class="p-6 sm:p-8 lg:p-10 rounded-[6px] bg-white border border-slate-200/90 shadow-md">
                    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 sm:gap-5">
                        ...
                        <div class="p-4 sm:p-5 rounded-[6px] bg-[#FAFAFA] border border-slate-200/70 hover:bg-white hover:shadow-sm transition-all text-center space-y-3 group flex flex-col justify-center items-center">
                            ...
                            <p class="text-xs sm:text-sm font-extrabold text-[#111111]">Figma</p>
                        </div>
                        ...
                        <div class="p-4 sm:p-5 rounded-[6px] bg-[#FAFAFA] border border-slate-200/70 hover:bg-white hover:shadow-sm transition-all text-center space-y-3 group flex flex-col justify-center items-center">
                            ...
                            <p class="text-xs sm:text-sm font-extrabold text-[#111111]">DevTools</p>
                        </div>

                        <!-- Tool 11: Photoshop Basics -->
                        <div class="p-4 sm:p-5 rounded-[6px] bg-[#FAFAFA] border border-slate-200/70 hover:bg-white hover:shadow-sm transition-all text-center space-y-3 group flex flex-col justify-center items-center">
                            <svg class="w-10 h-10 sm:w-11 sm:h-11 mx-auto shrink-0" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                    ...
                    <div class="p-6 sm:p-8 rounded-[6px] bg-white border border-slate-200/90 shadow-md hover:shadow-lg transition-all space-y-4">
                        <div class="flex items-center gap-3">
                            ...
                            <h3 class="text-base font-extrabold text-[#111111] font-heading">UI Design & Figma</h3>
                        </div>
                        <ul class="space-y-2 text-xs sm:text-sm text-[#555555]">
                            <li class="flex items-start gap-2"><span>•</span> <span>Color Theory & Typography</span></li>
                            <li class="flex items-start gap-2"><span>•</span> <span>Page Layout Principles</span></li>
                            <li class="flex items-start gap-2"><span>•</span> <span>Figma Wireframing & Prototyping</span></li>
                            <li class="flex items-start gap-2"><span>•</span> <span>Asset Export & Guidelines</span></li>
                        </ul>
                    </div>
                    ...
                    <div class="p-6 sm:p-8 rounded-[6px] bg-white border border-slate-200/90 shadow-md hover:shadow-lg transition-all space-y-4">
                        <div class="flex items-center gap-3">
                            ...
                            <h3 class="text-base font-extrabold text-[#111111] font-heading">HTML5 Markup</h3>
                        </div>
                        <ul class="space-y-2 text-xs sm:text-sm text-[#555555]">
                            <li class="flex items-start gap-2"><span>•</span> <span>HTML5 Semantic Tags</span></li>
                            <li class="flex items-start gap-2"><span>•</span> <span>Forms, Inputs & Validation</span></li>
                            <li class="flex items-start gap-2"><span>•</span> <span>Tables, Lists & Embeds</span></li>
                            <li class="flex items-start gap-2"><span>•</span> <span>Audio & Video Media Tags</span></li>
                        </ul>
                    </div>
                    ...
                    <div class="p-6 sm:p-8 rounded-[6px] bg-white border border-slate-200/90 shadow-md hover:shadow-lg transition-all space-y-4">
                        <div class="flex items-center gap-3">
                            ...
                            <h3 class="text-base font-extrabold text-[#111111] font-heading">CSS3 Styling & Flexbox</h3>
                        </div>
                        <ul class="space-y-2 text-xs sm:text-sm text-[#555555]">
                            <li class="flex items-start gap-2"><span>•</span> <span>CSS Flexbox & Grid Systems</span></li>
                            <li class="flex items-start gap-2"><span>•</span> <span>Keyframe Animations & Transitions</span></li>
                            <li class="flex items-start gap-2"><span>•</span> <span>Responsive Media Queries</span></li>
                            <li class="flex items-start gap-2"><span>•</span> <span>Custom Variables & Themes</span></li>
                        </ul>
                    </div>
                    ...
                    <div class="p-6 sm:p-8 rounded-[6px] bg-white border border-slate-200/90 shadow-md hover:shadow-lg transition-all space-y-4">
                        <div class="flex items-center gap-3">
                            ...
                            <h3 class="text-base font-extrabold text-[#111111] font-heading">Bootstrap 5 Framework</h3>
                        </div>
                        <ul class="space-y-2 text-xs sm:text-sm text-[#555555]">
                            <li class="flex items-start gap-2"><span>•</span> <span>12-Column Responsive Grid</span></li>
                            <li class="flex items-start gap-2"><span>•</span> <span>Navbars, Offcanvas & Modals</span></li>
                            <li class="flex items-start gap-2"><span>•</span> <span>Cards, Badges & Utility Classes</span></li>
                            <li class="flex items-start gap-2"><span>•</span> <span>Customizing Bootstrap Components</span></li>
                        </ul>
                    </div>
                    ...
                    <div class="p-6 sm:p-8 rounded-[6px] bg-white border border-slate-200/90 shadow-md hover:shadow-lg transition-all space-y-4">
                        <div class="flex items-center gap-3">
                            ...
                            <h3 class="text-base font-extrabold text-[#111111] font-heading">JavaScript Interactivity</h3>
                        </div>
                        <ul class="space-y-2 text-xs sm:text-sm text-[#555555]">
                            <li class="flex items-start gap-2"><span>•</span> <span>Variables, Functions & Scope</span></li>
                            <li class="flex items-start gap-2"><span>•</span> <span>DOM Manipulation & Click Events</span></li>
                            <li class="flex items-start gap-2"><span>•</span> <span>Form Validation & Sliders</span></li>
                            <li class="flex items-start gap-2"><span>•</span> <span>Fetch API & Dynamic Content</span></li>
                        </ul>
                    </div>
                    ...
                    <div class="p-6 sm:p-8 rounded-[6px] bg-white border border-slate-200/90 shadow-md hover:shadow-lg transition-all space-y-4">
                        <div class="flex items-center gap-3">
                            ...
                            <h3 class="text-base font-extrabold text-[#111111] font-heading">Deployment & Hosting</h3>
                        </div>
                        <ul class="space-y-2 text-xs sm:text-sm text-[#555555]">
                            <li class="flex items-start gap-2"><span>•</span> <span>GitHub Repositories & Pages</span></li>
                            <li class="flex items-start gap-2"><span>•</span> <span>Netlify & Vercel Free Hosting</span></li>
                            <li class="flex items-start gap-2"><span>•</span> <span>Custom Domain Connection</span></li>
                            <li class="flex items-start gap-2"><span>•</span> <span>SEO & Speed Optimization</span></li>
                        </ul>
                    </div>
            ...
            <div class="w-full max-w-[1360px] mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                    ...
                    <div class="p-4 sm:p-5 rounded-[6px] bg-white border border-slate-200/90 shadow-sm hover:shadow-md transition-all flex items-center gap-4">
                        ...
                        <h3 class="text-sm font-extrabold text-[#111111] font-heading">UI Developer</h3>
                    </div>
                    ...
                    <div class="p-4 sm:p-5 rounded-[6px] bg-white border border-slate-200/90 shadow-sm hover:shadow-md transition-all flex items-center gap-4">
                        ...
                        <h3 class="text-sm font-extrabold text-[#111111] font-heading">Bootstrap Developer</h3>
                    </div>
                    ...
                    <div class="p-4 sm:p-5 rounded-[6px] bg-white border border-slate-200/90 shadow-sm hover:shadow-md transition-all flex items-center gap-4">
                        ...
                        <h3 class="text-sm font-extrabold text-[#111111] font-heading">HTML/CSS Coder</h3>
                    </div>
                ...
                <div class="relative rounded-[6px] bg-[#FAFAFA] border border-slate-200/80 p-7 sm:p-10 lg:p-12 overflow-hidden flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12">
                    ...
                    <div class="relative z-10 space-y-4 text-center max-w-2xl mx-auto md:mx-0 md:text-left">
                        <h2 class="text-3xl sm:text-4xl lg:text-[40px] font-extrabold font-heading text-[#111111] leading-[1.15] tracking-tight">
                            ...
                            <span class="text-[#00A651]">Web Designing Journey?</span>
                        </h2>

                        <p class="text-xs sm:text-sm text-[#555555] font-medium leading-relaxed max-w-xl">
                            Join DigiCoders Academy and build modern responsive websites.
                        </p>
