    ...
    <main class="pt-[110px] sm:pt-[130px]">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
                    ...
                    <div class="lg:col-span-6 space-y-5 text-left">
                        ...
                        <p class="text-sm sm:text-base text-[#555555] font-medium leading-relaxed max-w-xl">
                            Need guidance about admissions, courses or career opportunities? Our expert team is here to
                            help you.
                        </p>
                    ...
                    <div class="lg:col-span-6 relative w-full">
                        <div
                            class="relative w-full rounded-2xl overflow-hidden shadow-2xl border-4 border-white bg-slate-100 group">
        ...
        <section class="py-14 sm:py-20 bg-slate-50 relative border-b border-slate-200/80">
            <div class="w-full max-w-[1360px] mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="text-center max-w-xl mx-auto mb-12 sm:mb-16">
                    <div
                        class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-100/60 border border-emerald-200 text-[#00A651] text-xs font-bold uppercase tracking-wider mb-3">
                        <i data-lucide="building-2" class="w-3.5 h-3.5"></i>
                        <span>Our Office Locations</span>
                    </div>
                    <h2 class="text-2xl sm:text-3xl lg:text-4xl font-extrabold font-heading text-[#111111]">Our Campuses
                        & Head Office</h2>
                    <div class="w-12 h-1 bg-[#F58220] rounded-full mx-auto mt-3"></div>
                    <p class="text-xs sm:text-sm text-[#555555] font-medium mt-3">Visit any of our state-of-the-art
                        learning campuses across Uttar Pradesh.</p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    @if(!empty($settings['office_lucknow_address']) || !empty($settings['office_lucknow_title']))
                        <div
                            class="p-6 sm:p-8 rounded-[12px] bg-white border border-slate-200 shadow-lg hover:shadow-xl transition-all space-y-4 flex flex-col justify-between relative overflow-hidden group">
                            <div
                                class="absolute top-0 right-0 bg-[#00A651] text-white text-[10px] font-black uppercase px-3 py-1 rounded-bl-lg tracking-wider">
                                Head Office
                            </div>
                            <div class="space-y-4">
                                <div
                                    class="w-12 h-12 rounded-xl bg-emerald-50 text-[#00A651] flex items-center justify-center shrink-0 shadow-inner">
                                    <i data-lucide="building" class="w-6 h-6"></i>
                                </div>
                                <div>
                                    <h3 class="text-lg font-black text-[#111111] font-heading">
                                        {{ $settings['office_lucknow_title'] ?? 'Lucknow Head Office' }}</h3>
                    ...
                    @if(!empty($settings['office_gorakhpur_address']) || !empty($settings['office_gorakhpur_title']))
                        <div
                            class="p-6 sm:p-8 rounded-[12px] bg-white border border-slate-200 shadow-lg hover:shadow-xl transition-all space-y-4 flex flex-col justify-between relative overflow-hidden group">
                            <div
                                class="absolute top-0 right-0 bg-[#F58220] text-white text-[10px] font-black uppercase px-3 py-1 rounded-bl-lg tracking-wider">
                                Branch Office
                            </div>
                            <div class="space-y-4">
                                <div
                                    class="w-12 h-12 rounded-xl bg-orange-50 text-[#F58220] flex items-center justify-center shrink-0 shadow-inner">
                                    <i data-lucide="map-pin" class="w-6 h-6"></i>
                                </div>
                                <div>
                                    <h3 class="text-lg font-black text-[#111111] font-heading">
                                        {{ $settings['office_gorakhpur_title'] ?? 'Gorakhpur Branch Office' }}</h3>
                    ...
                    @if(!empty($settings['office_kanpur_address']) || !empty($settings['office_kanpur_title']))
                        <div
                            class="p-6 sm:p-8 rounded-[12px] bg-white border border-slate-200 shadow-lg hover:shadow-xl transition-all space-y-4 flex flex-col justify-between relative overflow-hidden group">
                            <div class="absolute top-0 right-0 bg-[#0ea5e9] text-white text-[10px] font-black uppercase px-3 py-1 rounded-bl-lg tracking-wider"
                            ...
                            <div class="space-y-4">
                                <div class="w-12 h-12 rounded-xl bg-sky-50 text-[#0ea5e9] flex items-center justify-center shrink-0 shadow-inner"
                                    style="background-color: #f0f9ff; color: #0ea5e9;">
                                    <i data-lucide="map-pin" class="w-6 h-6"></i>
                                </div>
                                <div>
                                    <h3 class="text-lg font-black text-[#111111] font-heading">
                                        {{ $settings['office_kanpur_title'] ?? 'N/A' }}</h3>
                            ...
                            @if(!empty($settings['office_kanpur_map_link']))
                                <div class="pt-4">
                                    <a href="{{ $settings['office_kanpur_map_link'] }}" target="_blank"
                                        class="w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-[6px] bg-[#0ea5e9] hover:bg-[#0284c7] text-white text-xs font-bold transition-all shadow-sm group-hover:shadow-md"
                                        style="background-color: #0ea5e9; color: #ffffff;">
                                        <i data-lucide="map-pin" class="w-4 h-4"></i>
                                        <span>Get Directions / View Map</span>
                                    </a>
        ...
        <section id="contact-form" class="py-14 sm:py-20 bg-white relative border-b border-slate-200/60">
            <div class="w-full max-w-[1360px] mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="text-center max-w-xl mx-auto mb-12 sm:mb-16">
                    <h2 class="text-2xl sm:text-3xl lg:text-4xl font-extrabold font-heading text-[#111111]">Get In Touch
                    </h2>
                    <div class="w-12 h-1 bg-[#F58220] rounded-full mx-auto mt-3"></div>
                    <p class="text-xs sm:text-sm text-[#555555] font-medium mt-3">Send us a message and our counsellor
                        will reach out within 2 hours.</p>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                    ...
                    <div class="lg:col-span-7 p-6 sm:p-10 rounded-[6px] bg-white border border-slate-200/90 shadow-xl">
                        ...
                        @if(session('success'))
                            <div
                                style="background: rgba(0,166,81,0.08); border: 1px solid rgba(0,166,81,0.3); color: #007a3d; padding: 12px 16px; border-radius: 8px; font-size: 13px; font-weight: 600; margin-bottom: 20px; display: flex; align-items: center; gap: 10px;">
                                <i data-lucide="check-circle" class="w-4 h-4"></i> {{ session('success') }}
                            </div>
                        @endif
                        @if($errors->any())
                            <div
                                style="background: rgba(239,68,68,0.07); border: 1px solid rgba(239,68,68,0.25); color: #dc2626; padding: 12px 16px; border-radius: 8px; font-size: 13px; font-weight: 600; margin-bottom: 20px;">
                        ...
                        <!-- Compact Form Header -->
                        <div class="mb-4 pb-3 border-b border-slate-100 flex items-center justify-between gap-2 flex-wrap">
                            <div>
                                <h3 class="text-base font-extrabold font-heading text-[#111111]">
                                    Send Us a <span class="text-[#00A651]">Direct Message</span>
                                </h3>
                                <p class="text-[11px] text-[#64748B] font-medium mt-0.5">
                                    Our team will get in touch with you within 2 hours.
                                </p>
                            </div>
                            <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-emerald-50 text-[#00A651] text-[10px] font-bold">
                                <i data-lucide="sparkles" class="w-3 h-3"></i> Quick Enquiry
                            </span>
                        </div>
                        ...
                        <form id="contactForm" action="{{ route('contact.submit') }}" method="POST" class="space-y-5">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                <div class="space-y-1.5">
                                    <label class="text-xs font-extrabold text-[#111111]">Full Name <span
                                ...
                                <div class="space-y-1.5">
                                    <label class="text-xs font-extrabold text-[#111111]">Phone Number <span
                                            class="text-red-500">*</span></label>
                                    ...
                                    <p id="phoneError" class="text-red-500 text-[11px] font-semibold hidden">Must be 10
                                        digits and start with 6, 7, 8, or 9.</p>
                                </div>
                                ...
                                <div class="space-y-1.5">
                                    <label class="text-xs font-extrabold text-[#111111]">Course Interested In <span
                                            class="text-red-500">*</span></label>
                                    <select name="course"
                                        class="w-full px-4 py-3 rounded-[6px] bg-[#FAFAFA] border border-slate-200 text-xs sm:text-sm text-[#111111] focus:bg-white focus:border-[#00A651] outline-none">
                            ...
                            <div class="space-y-1.5">
                                <label class="text-xs font-extrabold text-[#111111]">Your Message / Question <span
                                        class="text-red-500">*</span></label>
                    ...
                    <div class="lg:col-span-5 space-y-6">
                        ...
                        <div
                            class="w-full h-64 sm:h-72 rounded-[6px] bg-white border border-slate-200/90 shadow-md overflow-hidden relative">
                            @if(!empty($settings['site_map_iframe']))
                                ...
                                @else
                                    <iframe src="{{ $settings['site_map_iframe'] }}" width="100%" height="100%"
                                        style="border:0;" allowfullscreen="" loading="lazy"
                                        referrerpolicy="no-referrer-when-downgrade"></iframe>
                                @endif
                            @elseif(!empty($settings['office_lucknow_map_link']))
                                <iframe src="{{ $settings['office_lucknow_map_link'] }}" width="100%" height="100%"
                                    style="border:0;" allowfullscreen="" loading="lazy"
                                    referrerpolicy="no-referrer-when-downgrade"></iframe>
                            @else
                                <div
                                    class="w-full h-full flex items-center justify-center text-slate-400 text-xs font-semibold p-4 text-center bg-slate-100">
                        ...
                        <div class="p-6 rounded-[6px] bg-[#FAFAFA] border border-slate-200/90 space-y-4 text-xs">
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-[#555555] mt-0.5 leading-relaxed">
                                        {{ $settings['office_lucknow_address'] ?? $settings['site_address'] ?? 'N/A' }}
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    @if(!empty($settings['site_landline']))
                                        <p class="text-[#555555] mt-0.5 font-medium">Landline:
                                            {{ $settings['site_landline'] }}</p>
                                    @endif
                                    @if(!empty($settings['site_whatsapp']))
                                        <p class="text-[#00A651] mt-0.5 font-semibold">WhatsApp:
                                            {{ $settings['site_whatsapp'] }}</p>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-[#555555] mt-0.5 font-medium">Working Hours:
                                        {{ $settings['site_working_hours'] ?? 'N/A' }}</p>
                                </div>
                            </div>
        ...
        <section id="why-contact" class="py-14 sm:py-20 bg-[#FAFAFA] relative border-b border-slate-200/60">
            <div class="w-full max-w-[1360px] mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="text-center max-w-xl mx-auto mb-12 sm:mb-16">
                    <h2 class="text-2xl sm:text-3xl lg:text-4xl font-extrabold font-heading text-[#111111]">Why Connect
                        With Us?</h2>
                    <div class="w-12 h-1 bg-[#F58220] rounded-full mx-auto mt-3"></div>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div class="p-6 rounded-[6px] bg-white border border-slate-200/90 shadow-md text-center space-y-3">
                        ...
                        <p class="text-xs text-[#555555]">Information about campus placement drives & corporate tie-ups.
                        </p>
                    </div>
                    ...
                    @forelse($faqs ?? [] as $index => $fItem)
                        @if(!empty($fItem) && (is_object($fItem) || is_array($fItem)))
                            <div class="rounded-[6px] bg-[#FAFAFA] border border-slate-200/90 overflow-hidden shadow-2xs">
                                <button onclick="toggleFaq('cnt-{{ data_get($fItem, 'id') }}')"
                                    class="w-full p-5 text-left flex items-center justify-between font-extrabold text-sm text-[#111111] font-heading cursor-pointer">
                                    <span>{{ data_get($fItem, 'question') }}</span>
                                    <i data-lucide="chevron-down" id="faq-icon-cnt-{{ data_get($fItem, 'id') }}"
                                        class="w-4 h-4 text-[#F58220] transition-transform duration-300"></i>
                                </button>
                                <div id="faq-ans-cnt-{{ data_get($fItem, 'id') }}"
                                    class="hidden px-5 pb-5 text-xs sm:text-sm text-[#555555] leading-relaxed border-t border-slate-200/60 pt-3">
        ...
        <section id="final-cta"
            class="py-14 sm:py-20 bg-[#FAFAFA] relative border-b border-slate-200/60 overflow-hidden">
            <div class="w-full max-w-[1360px] mx-auto px-4 sm:px-6 lg:px-8">

                <div
                    class="relative rounded-[6px] bg-white border border-slate-200/90 p-8 sm:p-12 lg:p-16 text-center space-y-6 max-w-4xl mx-auto shadow-xl">
                    <div class="space-y-3">
                        <span
                            class="px-3 py-1 rounded-full bg-emerald-50 border border-[#00A651]/20 text-[#00A651] text-xs font-extrabold uppercase">
                            TAKE THE FIRST STEP
                        </span>
                        <h2 class="text-3xl sm:text-4xl lg:text-5xl font-bold font-heading text-[#111111]">Ready To
                            Start Your Journey?</h2>
                        <p class="text-xs sm:text-sm text-[#555555]">Connect with DigiCoders Academy today and transform
                            your career.</p>
                    </div>
