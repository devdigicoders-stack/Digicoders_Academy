...
<body
    ...
    <!-- 1. APPLY NOW MODAL -->
    <div id="applyModal"
        class="fixed inset-0 z-50 hidden overflow-y-auto bg-black/60 backdrop-blur-xs flex items-center justify-center p-4">
        <div
            class="relative w-full max-w-lg bg-white rounded-[24px] shadow-2xl p-6 sm:p-8 space-y-5 border border-slate-100 animate-in fade-in zoom-in-95 duration-200">
            <button onclick="closeModal('applyModal')"
                class="absolute top-5 right-5 w-8 h-8 rounded-full bg-slate-100 hover:bg-slate-200 text-slate-600 flex items-center justify-center cursor-pointer transition-colors">
                <i data-lucide="x" class="w-4 h-4"></i>
            </button>

            <div class="space-y-1">
                <span class="text-[10px] font-bold uppercase tracking-wider text-[#00A651]">ADMISSION 2026</span>
                <h3 class="text-xl font-bold font-heading text-[#111111]">Apply For Admission</h3>
                <p class="text-xs text-[#666666]">Fill in your details to reserve your seat in upcoming batches.</p>
            </div>

            <form class="space-y-3.5 pt-2"
                onsubmit="event.preventDefault(); alert('Application submitted successfully!'); closeModal('applyModal');">
                <div>
                    <label class="block text-xs font-semibold text-[#111111] mb-1">Full Name</label>
                    <input type="text" required placeholder="Enter your full name"
                        class="w-full px-3.5 py-2.5 text-xs rounded-[10px] border border-slate-200 focus:outline-hidden focus:border-[#F58220]">
                </div>
                <div>
                    <label class="block text-xs font-semibold text-[#111111] mb-1">Mobile Number</label>
                    <input type="tel" required placeholder="Enter 10-digit phone number"
                        class="w-full px-3.5 py-2.5 text-xs rounded-[10px] border border-slate-200 focus:outline-hidden focus:border-[#F58220]">
                </div>
                <div>
                    <label class="block text-xs font-semibold text-[#111111] mb-1">Course Interested In</label>
                    <select required
                        class="w-full px-3.5 py-2.5 text-xs rounded-[10px] border border-slate-200 focus:outline-hidden focus:border-[#F58220]">
                        <option value="">Select a course</option>
                        <option value="web-dev">Full Stack Web Development</option>
                        <option value="python">Python & Machine Learning</option>
                        <option value="app-dev">Android & Flutter App Development</option>
                        <option value="ui-ux">UI/UX Design & Frontend</option>
                        <option value="digital-marketing">Digital Marketing</option>
                    </select>
                </div>
                <button type="submit"
                    class="w-full bg-[#F58220] hover:bg-[#e07316] text-white py-3 rounded-[10px] text-xs font-bold transition-all cursor-pointer shadow-md mt-2">
                    Submit Application
                </button>
            </form>
        </div>
    ...
    <!-- 2. DOWNLOAD BROCHURE MODAL -->
    <div id="brochureModal"
        class="fixed inset-0 z-50 hidden overflow-y-auto bg-black/60 backdrop-blur-xs flex items-center justify-center p-4">
        <div
            class="relative w-full max-w-lg bg-white rounded-[24px] shadow-2xl p-6 sm:p-8 space-y-5 border border-slate-100 animate-in fade-in zoom-in-95 duration-200">
            <button onclick="closeModal('brochureModal')"
                class="absolute top-5 right-5 w-8 h-8 rounded-full bg-slate-100 hover:bg-slate-200 text-slate-600 flex items-center justify-center cursor-pointer transition-colors">
                <i data-lucide="x" class="w-4 h-4"></i>
            </button>

            <div class="space-y-1">
                <span class="text-[10px] font-bold uppercase tracking-wider text-[#00A651]">ACADEMY PROSPECTUS</span>
                <h3 class="text-xl font-bold font-heading text-[#111111]">Download Prospectus</h3>
                <p class="text-xs text-[#666666]">Enter your phone number to receive the detailed course guide PDF.</p>
            </div>

            <form class="space-y-3.5 pt-2"
                onsubmit="event.preventDefault(); alert('Prospectus sent to your phone!'); closeModal('brochureModal');">
                <div>
                    <label class="block text-xs font-semibold text-[#111111] mb-1">Full Name</label>
                    <input type="text" required placeholder="Enter your full name"
                        class="w-full px-3.5 py-2.5 text-xs rounded-[10px] border border-slate-200 focus:outline-hidden focus:border-[#00A651]">
                </div>
                <div>
                    <label class="block text-xs font-semibold text-[#111111] mb-1">WhatsApp Number</label>
                    <input type="tel" required placeholder="Enter WhatsApp phone number"
                        class="w-full px-3.5 py-2.5 text-xs rounded-[10px] border border-slate-200 focus:outline-hidden focus:border-[#00A651]">
                </div>
                <button type="submit"
                    class="w-full bg-[#00A651] hover:bg-[#008f45] text-white py-3 rounded-[10px] text-xs font-bold transition-all cursor-pointer shadow-md mt-2">
